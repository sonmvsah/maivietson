...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "a.nuxt-link-exact-active{color:#9acd32}.text-stroke-mvs{-webkit-text-fill-color:transparent;-webkit-text-stroke-width:2px;-webkit-text-stroke-color:#fff;opacity:.8}.h1{font-size:9.4vw;font-weight:700;text-transform:uppercase;line-height:1.25}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=760f37a8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bg-gradient-to-b from-second-600 to-sblack"},[_vm._ssrNode("<section class=\"relative w-full bg-gradient-to-b from-second-600 to-[#000000] 1bg-dark 1bg-white px-5 mt-0 md:mt-0 md:px-32 z-0  mvs-h-screen  md:mvs-max-h-screen bg-pattem\">","</section>",[_vm._ssrNode("<div class=\"relative w-full px-5 mx-auto md:px-10 max-w-7xl  bg-transparent rounded-xl\">","</div>",[_vm._ssrNode("<div class=\"flex flex-row\">","</div>",[_vm._ssrNode("<div class=\"md:basis-1/2\">","</div>",[_vm._ssrNode("<h1 class=\"mb-1 text-center text-4xl font-extrabold leading-none text-white lg:text-5xl xl:text-6xl sm:mb-3 1text-stroke 1text-stroke-mvs pt-[5rem] sm:pt-[5rem] md:pt-[8rem]  text-transparent text-second-gray bg-clip-text bg-gradient-to-b from-gray-600 to-[#4187BF] \">Chân dung khách hàng mang lại cho bạn quyết định về mặt thiết kế UI - UX\n\n\n                </h1> "),_vm._ssrNode("<div class=\"md:hidden md:basis-1/2 text-center 1flex 1max-h-[375px] mvs-h-screen max-h-[200px] contents\">","</div>",[_c('video-background',{staticClass:"bg-pattem 1absolute 1max-h-[200px] mobile",staticStyle:{"max-height":"200px","height":"100vh"},attrs:{"src":"/images/bong.mp4","overlay":"rgba(37, 36, 34, var(--tw-bg-opacity))"}})],1)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"absolute hidden md:basis-1/2 md:block mvs-h-screen 1mvs-max-h-screen  relative mt-[7rem] max-h-[400px]\">","</div>",[_c('video-background',{staticClass:"bg-pattem mix-blend-light 1mt-[7rem] max-h-[400px]",staticStyle:{"max-height":"400px","height":"100vh"},attrs:{"src":"/images/bong.mp4","overlay":"rgba(37, 36, 34, var(--tw-bg-opacity))"}})],1)],2)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=760f37a8&
