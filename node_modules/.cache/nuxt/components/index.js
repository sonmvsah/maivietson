...
export const FooterBio = () => import('../../../../components/footer/bio.vue' /* webpackChunkName: "components/footer-bio" */).then(c => wrapFunctional(c.default || c))
export const FooterBot = () => import('../../../../components/footer/bot.vue' /* webpackChunkName: "components/footer-bot" */).then(c => wrapFunctional(c.default || c))
...
export const HomeTableItem = () => import('../../../../components/home/Table/TableItem.vue' /* webpackChunkName: "components/home-table-item" */).then(c => wrapFunctional(c.default || c))
export const HomeTable = () => import('../../../../components/home/Table/index.vue' /* webpackChunkName: "components/home-table" */).then(c => wrapFunctional(c.default || c))
export const HomeAboutmeTableItem = () => import('../../../../components/home/aboutme/TableItem.vue' /* webpackChunkName: "components/home-aboutme-table-item" */).then(c => wrapFunctional(c.default || c))
export const HomeAboutme = () => import('../../../../components/home/aboutme/index.vue' /* webpackChunkName: "components/home-aboutme" */).then(c => wrapFunctional(c.default || c))
export const HomeBanner = () => import('../../../../components/home/banner/index.vue' /* webpackChunkName: "components/home-banner" */).then(c => wrapFunctional(c.default || c))
